...
import ChatBoard from "../components/AdminDashboard/queries/chatBoard";
              ...
              <main className={classes.content}>
                ...
                <Container maxWidth="lg" className={classes.container}>
                  <Grid container spacing={3}>
                    ...
                    <TabPanel value={value} index={4} chatBoard={true} />
                  </Grid>
                  <Box pt={4}>
                    <Copyright />
                  </Box>
...
function TabPanel(props) {
  const { value, index, users, Dashboard, products,orders,chatBoard } = props;
