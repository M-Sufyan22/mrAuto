  ...
  return (
    <div className={classes.root}>
      ...
      <div className="container-lg " style={{ margin: "30px auto" }}>
        <div className="row">
          <div className="col-6 d-flex align-items-center justify-content-start"><GoBackBtn home="/" /> <IconBreadcrumb Shop={"Shop"} AllProd={"All-Products"} /></div>
          <div className="col-6  p-5 d-flex align-items-center justify-content-end">
              ...
              {Object.keys(categoryList).map((categoryName, ind) => {
                ...
                return (
                  <Button component={Link} key={ind}
                    ...
                    params={{ category: `${categoryName}` }} style={{ textDecoration: "none", color: "#fff" }}>{categoryName}</Button>
