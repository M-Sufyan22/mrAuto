  ...
  <CardMedia key={ind}
    ...
    />
          ...
          <div className="col-md-6">
                  ...
                  <tr>
                    <td className="pl-0">
                      <div className="quantity-wrapper">
                        ...
                        <input className="quantity" min={0} name="quantity" defaultValue={1} type="number" value={inputQtn}  readonly/>
            ...
            <button onClick={handleAddtoCart} type="button" className="btn btn-success btn-md mr-1 mb-2">Add to cart</button>
